...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.option_menu = self.option_menu = customtkinter.CTkOptionMenu(self, values=self.options, width=button_size, command=self.change_flag)
        self.option_menu.grid(row=0, column=0, columnspan=4, padx=padx, pady=pady, sticky="w")

            
        # Цифры
        if self.flag_change == 0:
            self.entry = customtkinter.CTkEntry(self, width=button_size, state = "disabled")
            self.entry.grid(row=1, column=0, columnspan=4, padx=padx, pady=pady)
            ...
            self.button_division.grid(row=5, column=3, padx=padx, pady=pady)
            ...
            self.button_result.grid(row=5, column=0, columnspan=3, padx=padx, pady=pady)
