...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        if flag_change == 0:
            ...
            self.button_7 = customtkinter.CTkButton(self, text="7", width=button_size, height=button_size, command=self.emt)
            self.button_7.grid(row=1, column=0, padx=padx, pady=pady)

            self.button_8 = customtkinter.CTkButton(self, text="8", width=button_size, height=button_size, command=self.emt)
            self.button_8.grid(row=1, column=1, padx=padx, pady=pady)

            self.button_9 = customtkinter.CTkButton(self, text="9", width=button_size, height=button_size, command=self.emt)
            self.button_9.grid(row=1, column=2, padx=padx, pady=pady)

            self.button_4 = customtkinter.CTkButton(self, text="4", width=button_size, height=button_size, command=self.emt)
            self.button_4.grid(row=2, column=0, padx=padx, pady=pady)

            self.button_5 = customtkinter.CTkButton(self, text="5", width=button_size, height=button_size, command=self.emt)
            self.button_5.grid(row=2, column=1, padx=padx, pady=pady)

            self.button_6 = customtkinter.CTkButton(self, text="6", width=button_size, height=button_size, command=self.emt)
            self.button_6.grid(row=2, column=2, padx=padx, pady=pady)

            self.button_1 = customtkinter.CTkButton(self, text="1", width=button_size, height=button_size, command=self.emt)
            self.button_1.grid(row=3, column=0, padx=padx, pady=pady)

            self.button_2 = customtkinter.CTkButton(self, text="2", width=button_size, height=button_size, command=self.emt)
            self.button_2.grid(row=3, column=1, padx=padx, pady=pady)

            self.button_3 = customtkinter.CTkButton(self, text="3", width=button_size, height=button_size, command=self.emt)
