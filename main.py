...
class App(customtkinter.CTk):  
    ...
    def __init__(self):
        ...
        # Цифры
        if flag_change == 0:
            self.entry = customtkinter.CTkEntry(self, width=9999, fg_color= "#242424", border_color= "#242424", height=80, font = my_font)
            ...
            self.button_backspace = customtkinter.CTkButton(self, text="↫",  fg_color= "#474747",width=button_size, height=button_size,  font = button_font,command=lambda:self.entry_text(self.button_backspace.cget("text")))
